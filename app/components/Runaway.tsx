    ...
    <div className="bg-black flex flex-col lg:flex-row gap-4 lg:gap-40 m-32">
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          >
            <span className="font-extrabold text-[22px] text-white">run away</span> build times from 7m to 40s.
            <span className="flex gap-2">
              <Image src="/leonardo.png" alt="leonardo" width={100} height={100} />
      ...
      >
        <p className="text-white">
          Get started using our pre-built templates. Easily stream long-running LLM responses for a better user
          experience with zero-config infrastructure that’s always globally performant.
        </p>
