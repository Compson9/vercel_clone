...
export default function CodeBase() {
  return (
    <div className='flex justify-center gap-24 items-center w-[1079px] h-[678px] p-20 mt-32 mx-24'>
      <div className="left w-[719px]  h-[705px] ml-20">
        <div className="code">
          <CodeBlock1/>
           ...
           <span className='text-gray-500 text-[16px] font-semibold'>Experience seamless integration, optimized performance, <br />
      ...
      <div className="right w-[359px] flex flex-col   h-[705px]">
        <div className="code">
          ...
          <div className=' mt-[-10px]'>
            <p className=' text-white'>All the data. Connect with content, <br /> <span className='text-gray-500 font-semibold'>commerce or database platforms.</span></p>
